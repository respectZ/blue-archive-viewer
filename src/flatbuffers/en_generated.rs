...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_CLUB: i32 = 47;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_CLUB: [Club; 48] = [
  Club::None,
  Club::Engineer,
  Club::CleanNClearing,
...
pub enum CharacterDialogExcelTableOffset {}
#[derive(Copy, Clone, PartialEq)]

pub struct CharacterDialogExcelTable<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for CharacterDialogExcelTable<'a> {
  type Inner = CharacterDialogExcelTable<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> CharacterDialogExcelTable<'a> {
  pub const VT_DATA_LIST: flatbuffers::VOffsetT = 4;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    CharacterDialogExcelTable { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args CharacterDialogExcelTableArgs<'args>
  ) -> flatbuffers::WIPOffset<CharacterDialogExcelTable<'bldr>> {
    let mut builder = CharacterDialogExcelTableBuilder::new(_fbb);
    if let Some(x) = args.data_list { builder.add_data_list(x); }
    builder.finish()
  }
  ...
  #[inline]
  pub fn data_list(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<CharacterDialogExcel<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<CharacterDialogExcel>>>>(CharacterDialogExcelTable::VT_DATA_LIST, None)}
  }
}

impl flatbuffers::Verifiable for CharacterDialogExcelTable<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<CharacterDialogExcel>>>>("data_list", Self::VT_DATA_LIST, false)?
     .finish();
    Ok(())
  }
}
pub struct CharacterDialogExcelTableArgs<'a> {
    pub data_list: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<CharacterDialogExcel<'a>>>>>,
}
impl<'a> Default for CharacterDialogExcelTableArgs<'a> {
  #[inline]
  fn default() -> Self {
    CharacterDialogExcelTableArgs {
      data_list: None,
    }
  }
}

pub struct CharacterDialogExcelTableBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> CharacterDialogExcelTableBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_data_list(&mut self, data_list: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<CharacterDialogExcel<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(CharacterDialogExcelTable::VT_DATA_LIST, data_list);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> CharacterDialogExcelTableBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    CharacterDialogExcelTableBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<CharacterDialogExcelTable<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for CharacterDialogExcelTable<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("CharacterDialogExcelTable");
      ds.field("data_list", &self.data_list());
      ds.finish()
  }
}
...
impl<'a> CharacterDialogExcel<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.localize_en { builder.add_localize_en(x); }
    if let Some(x) = args.localize_tw { builder.add_localize_tw(x); }
    if let Some(x) = args.localize_th { builder.add_localize_th(x); }
    ...
    builder.add_teen_mode(args.teen_mode);
  ...
  pub fn localize_th(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(CharacterDialogExcel::VT_LOCALIZE_TH, None)}
  }
  #[inline]
  pub fn localize_tw(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(CharacterDialogExcel::VT_LOCALIZE_TW, None)}
  }
  #[inline]
  pub fn localize_en(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(CharacterDialogExcel::VT_LOCALIZE_EN, None)}
  }
  #[inline]
  ...
  pub fn teen_mode(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(CharacterDialogExcel::VT_TEEN_MODE, Some(false)).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for CharacterDialogExcel<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("localize_th", Self::VT_LOCALIZE_TH, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("localize_tw", Self::VT_LOCALIZE_TW, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("localize_en", Self::VT_LOCALIZE_EN, false)?
...
pub struct CharacterDialogExcelArgs<'a> {
    ...
    pub localize_th: Option<flatbuffers::WIPOffset<&'a str>>,
    pub localize_tw: Option<flatbuffers::WIPOffset<&'a str>>,
    pub localize_en: Option<flatbuffers::WIPOffset<&'a str>>,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> CharacterDialogExcelBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_localize_th(&mut self, localize_th: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(CharacterDialogExcel::VT_LOCALIZE_TH, localize_th);
  }
  #[inline]
  pub fn add_localize_tw(&mut self, localize_tw: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(CharacterDialogExcel::VT_LOCALIZE_TW, localize_tw);
  }
  #[inline]
  pub fn add_localize_en(&mut self, localize_en: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(CharacterDialogExcel::VT_LOCALIZE_EN, localize_en);
  }
  #[inline]
  ...
  #[inline]
  pub fn add_teen_mode(&mut self, teen_mode: bool) {
    self.fbb_.push_slot::<bool>(CharacterDialogExcel::VT_TEEN_MODE, teen_mode, false);
  }
  #[inline]
...
impl<'a> LocalizeCharProfileExcel<'a> {
  ...
  pub const VT_STATUS_MESSAGE_TH: flatbuffers::VOffsetT = 10;
  pub const VT_STATUS_MESSAGE_TW: flatbuffers::VOffsetT = 12;
  pub const VT_STATUS_MESSAGE_EN: flatbuffers::VOffsetT = 14;
  pub const VT_FULL_NAME_KR: flatbuffers::VOffsetT = 16;
  pub const VT_FULL_NAME_JP: flatbuffers::VOffsetT = 18;
  pub const VT_FULL_NAME_TH: flatbuffers::VOffsetT = 20;
  pub const VT_FULL_NAME_TW: flatbuffers::VOffsetT = 22;
  pub const VT_FULL_NAME_EN: flatbuffers::VOffsetT = 24;
  pub const VT_FAMILY_NAME_KR: flatbuffers::VOffsetT = 26;
  pub const VT_FAMILY_NAME_RUBY_KR: flatbuffers::VOffsetT = 28;
  pub const VT_PERSONAL_NAME_KR: flatbuffers::VOffsetT = 30;
  pub const VT_PERSONAL_NAME_RUBY_KR: flatbuffers::VOffsetT = 32;
  pub const VT_FAMILY_NAME_JP: flatbuffers::VOffsetT = 34;
  pub const VT_FAMILY_NAME_RUBY_JP: flatbuffers::VOffsetT = 36;
  pub const VT_PERSONAL_NAME_JP: flatbuffers::VOffsetT = 38;
  pub const VT_PERSONAL_NAME_RUBY_JP: flatbuffers::VOffsetT = 40;
  pub const VT_FAMILY_NAME_TH: flatbuffers::VOffsetT = 42;
  pub const VT_FAMILY_NAME_RUBY_TH: flatbuffers::VOffsetT = 44;
  pub const VT_PERSONAL_NAME_TH: flatbuffers::VOffsetT = 46;
  pub const VT_PERSONAL_NAME_RUBY_TH: flatbuffers::VOffsetT = 48;
  pub const VT_FAMILY_NAME_TW: flatbuffers::VOffsetT = 50;
  pub const VT_FAMILY_NAME_RUBY_TW: flatbuffers::VOffsetT = 52;
  pub const VT_PERSONAL_NAME_TW: flatbuffers::VOffsetT = 54;
  pub const VT_PERSONAL_NAME_RUBY_TW: flatbuffers::VOffsetT = 56;
  pub const VT_FAMILY_NAME_EN: flatbuffers::VOffsetT = 58;
  pub const VT_FAMILY_NAME_RUBY_EN: flatbuffers::VOffsetT = 60;
  pub const VT_PERSONAL_NAME_EN: flatbuffers::VOffsetT = 62;
  pub const VT_PERSONAL_NAME_RUBY_EN: flatbuffers::VOffsetT = 64;
  pub const VT_SCHOOL_YEAR_KR: flatbuffers::VOffsetT = 66;
  pub const VT_SCHOOL_YEAR_JP: flatbuffers::VOffsetT = 68;
  pub const VT_SCHOOL_YEAR_TH: flatbuffers::VOffsetT = 70;
  pub const VT_SCHOOL_YEAR_TW: flatbuffers::VOffsetT = 72;
  pub const VT_SCHOOL_YEAR_EN: flatbuffers::VOffsetT = 74;
  pub const VT_CHARACTER_AGE_KR: flatbuffers::VOffsetT = 76;
  pub const VT_CHARACTER_AGE_JP: flatbuffers::VOffsetT = 78;
  pub const VT_CHARACTER_AGE_TH: flatbuffers::VOffsetT = 80;
  pub const VT_CHARACTER_AGE_TW: flatbuffers::VOffsetT = 82;
  pub const VT_CHARACTER_AGE_EN: flatbuffers::VOffsetT = 84;
  pub const VT_BIRTH_DAY: flatbuffers::VOffsetT = 86;
  pub const VT_BIRTHDAY_KR: flatbuffers::VOffsetT = 88;
  pub const VT_BIRTHDAY_JP: flatbuffers::VOffsetT = 90;
  pub const VT_BIRTHDAY_TH: flatbuffers::VOffsetT = 92;
  pub const VT_BIRTHDAY_TW: flatbuffers::VOffsetT = 94;
  pub const VT_BIRTHDAY_EN: flatbuffers::VOffsetT = 96;
  pub const VT_CHAR_HEIGHT_KR: flatbuffers::VOffsetT = 98;
  pub const VT_CHAR_HEIGHT_JP: flatbuffers::VOffsetT = 100;
  pub const VT_CHAR_HEIGHT_TH: flatbuffers::VOffsetT = 102;
  pub const VT_CHAR_HEIGHT_TW: flatbuffers::VOffsetT = 104;
  pub const VT_CHAR_HEIGHT_EN: flatbuffers::VOffsetT = 106;
  pub const VT_DESIGNER_NAME_KR: flatbuffers::VOffsetT = 108;
  pub const VT_DESIGNER_NAME_JP: flatbuffers::VOffsetT = 110;
  pub const VT_DESIGNER_NAME_TH: flatbuffers::VOffsetT = 112;
  pub const VT_DESIGNER_NAME_TW: flatbuffers::VOffsetT = 114;
  pub const VT_DESIGNER_NAME_EN: flatbuffers::VOffsetT = 116;
  pub const VT_ILLUSTRATOR_NAME_KR: flatbuffers::VOffsetT = 118;
  pub const VT_ILLUSTRATOR_NAME_JP: flatbuffers::VOffsetT = 120;
  pub const VT_ILLUSTRATOR_NAME_TH: flatbuffers::VOffsetT = 122;
  pub const VT_ILLUSTRATOR_NAME_TW: flatbuffers::VOffsetT = 124;
  pub const VT_ILLUSTRATOR_NAME_EN: flatbuffers::VOffsetT = 126;
  pub const VT_CHARACTER_VOICE_KR: flatbuffers::VOffsetT = 128;
  pub const VT_CHARACTER_VOICE_JP: flatbuffers::VOffsetT = 130;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    builder.add_character_id(args.character_id);
    if let Some(x) = args.character_ssr_new_en { builder.add_character_ssr_new_en(x); }
    if let Some(x) = args.character_ssr_new_tw { builder.add_character_ssr_new_tw(x); }
    if let Some(x) = args.character_ssr_new_th { builder.add_character_ssr_new_th(x); }
    ...
    if let Some(x) = args.profile_introduction_en { builder.add_profile_introduction_en(x); }
    if let Some(x) = args.profile_introduction_tw { builder.add_profile_introduction_tw(x); }
    if let Some(x) = args.profile_introduction_th { builder.add_profile_introduction_th(x); }
    ...
    if let Some(x) = args.weapon_desc_en { builder.add_weapon_desc_en(x); }
    if let Some(x) = args.weapon_name_en { builder.add_weapon_name_en(x); }
    if let Some(x) = args.weapon_desc_tw { builder.add_weapon_desc_tw(x); }
    if let Some(x) = args.weapon_name_tw { builder.add_weapon_name_tw(x); }
    if let Some(x) = args.weapon_desc_th { builder.add_weapon_desc_th(x); }
    if let Some(x) = args.weapon_name_th { builder.add_weapon_name_th(x); }
    ...
    if let Some(x) = args.hobby_en { builder.add_hobby_en(x); }
    if let Some(x) = args.hobby_tw { builder.add_hobby_tw(x); }
    ...
    if let Some(x) = args.illustrator_name_en { builder.add_illustrator_name_en(x); }
    if let Some(x) = args.illustrator_name_tw { builder.add_illustrator_name_tw(x); }
    if let Some(x) = args.illustrator_name_th { builder.add_illustrator_name_th(x); }
    ...
    if let Some(x) = args.designer_name_en { builder.add_designer_name_en(x); }
    if let Some(x) = args.designer_name_tw { builder.add_designer_name_tw(x); }
    if let Some(x) = args.designer_name_th { builder.add_designer_name_th(x); }
    ...
    if let Some(x) = args.char_height_en { builder.add_char_height_en(x); }
    if let Some(x) = args.char_height_tw { builder.add_char_height_tw(x); }
    if let Some(x) = args.char_height_th { builder.add_char_height_th(x); }
    ...
    if let Some(x) = args.birthday_en { builder.add_birthday_en(x); }
    if let Some(x) = args.birthday_tw { builder.add_birthday_tw(x); }
    if let Some(x) = args.birthday_th { builder.add_birthday_th(x); }
    ...
    if let Some(x) = args.character_age_en { builder.add_character_age_en(x); }
    if let Some(x) = args.character_age_tw { builder.add_character_age_tw(x); }
    if let Some(x) = args.character_age_th { builder.add_character_age_th(x); }
    ...
    if let Some(x) = args.school_year_en { builder.add_school_year_en(x); }
    if let Some(x) = args.school_year_tw { builder.add_school_year_tw(x); }
    if let Some(x) = args.school_year_th { builder.add_school_year_th(x); }
    ...
    if let Some(x) = args.personal_name_ruby_en { builder.add_personal_name_ruby_en(x); }
    if let Some(x) = args.personal_name_en { builder.add_personal_name_en(x); }
    if let Some(x) = args.family_name_ruby_en { builder.add_family_name_ruby_en(x); }
    if let Some(x) = args.family_name_en { builder.add_family_name_en(x); }
    if let Some(x) = args.personal_name_ruby_tw { builder.add_personal_name_ruby_tw(x); }
    if let Some(x) = args.personal_name_tw { builder.add_personal_name_tw(x); }
    if let Some(x) = args.family_name_ruby_tw { builder.add_family_name_ruby_tw(x); }
    if let Some(x) = args.family_name_tw { builder.add_family_name_tw(x); }
    if let Some(x) = args.personal_name_ruby_th { builder.add_personal_name_ruby_th(x); }
    if let Some(x) = args.personal_name_th { builder.add_personal_name_th(x); }
    if let Some(x) = args.family_name_ruby_th { builder.add_family_name_ruby_th(x); }
    if let Some(x) = args.family_name_th { builder.add_family_name_th(x); }
    ...
    if let Some(x) = args.full_name_en { builder.add_full_name_en(x); }
    if let Some(x) = args.full_name_tw { builder.add_full_name_tw(x); }
    if let Some(x) = args.full_name_th { builder.add_full_name_th(x); }
    if let Some(x) = args.full_name_jp { builder.add_full_name_jp(x); }
    if let Some(x) = args.full_name_kr { builder.add_full_name_kr(x); }
    if let Some(x) = args.status_message_en { builder.add_status_message_en(x); }
    if let Some(x) = args.status_message_tw { builder.add_status_message_tw(x); }
    if let Some(x) = args.status_message_th { builder.add_status_message_th(x); }
  ...
  #[inline]
  pub fn status_message_th(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_STATUS_MESSAGE_TH, None)}
  }
  #[inline]
  pub fn status_message_tw(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_STATUS_MESSAGE_TW, None)}
  }
  #[inline]
  pub fn status_message_en(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_STATUS_MESSAGE_EN, None)}
  }
  #[inline]
  ...
  #[inline]
  pub fn full_name_th(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_FULL_NAME_TH, None)}
  }
  #[inline]
  pub fn full_name_tw(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_FULL_NAME_TW, None)}
  }
  #[inline]
  pub fn full_name_en(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_FULL_NAME_EN, None)}
  }
  #[inline]
  ...
  #[inline]
  pub fn family_name_th(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_FAMILY_NAME_TH, None)}
  }
  #[inline]
  pub fn family_name_ruby_th(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_FAMILY_NAME_RUBY_TH, None)}
  }
  #[inline]
  pub fn personal_name_th(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_PERSONAL_NAME_TH, None)}
  }
  #[inline]
  pub fn personal_name_ruby_th(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_PERSONAL_NAME_RUBY_TH, None)}
  }
  #[inline]
  pub fn family_name_tw(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_FAMILY_NAME_TW, None)}
  }
  #[inline]
  pub fn family_name_ruby_tw(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_FAMILY_NAME_RUBY_TW, None)}
  }
  #[inline]
  pub fn personal_name_tw(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_PERSONAL_NAME_TW, None)}
  }
  #[inline]
  pub fn personal_name_ruby_tw(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_PERSONAL_NAME_RUBY_TW, None)}
  }
  #[inline]
  pub fn family_name_en(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_FAMILY_NAME_EN, None)}
  }
  #[inline]
  pub fn family_name_ruby_en(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_FAMILY_NAME_RUBY_EN, None)}
  }
  #[inline]
  pub fn personal_name_en(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_PERSONAL_NAME_EN, None)}
  }
  #[inline]
  pub fn personal_name_ruby_en(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_PERSONAL_NAME_RUBY_EN, None)}
  }
  #[inline]
  ...
  #[inline]
  pub fn school_year_th(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_SCHOOL_YEAR_TH, None)}
  }
  #[inline]
  pub fn school_year_tw(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_SCHOOL_YEAR_TW, None)}
  }
  #[inline]
  pub fn school_year_en(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_SCHOOL_YEAR_EN, None)}
  }
  #[inline]
  ...
  #[inline]
  pub fn character_age_th(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_CHARACTER_AGE_TH, None)}
  }
  #[inline]
  pub fn character_age_tw(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_CHARACTER_AGE_TW, None)}
  }
  #[inline]
  pub fn character_age_en(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_CHARACTER_AGE_EN, None)}
  }
  #[inline]
  ...
  #[inline]
  pub fn birthday_th(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_BIRTHDAY_TH, None)}
  }
  #[inline]
  pub fn birthday_tw(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_BIRTHDAY_TW, None)}
  }
  #[inline]
  pub fn birthday_en(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_BIRTHDAY_EN, None)}
  }
  #[inline]
  ...
  #[inline]
  pub fn char_height_th(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_CHAR_HEIGHT_TH, None)}
  }
  #[inline]
  pub fn char_height_tw(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_CHAR_HEIGHT_TW, None)}
  }
  #[inline]
  pub fn char_height_en(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_CHAR_HEIGHT_EN, None)}
  }
  #[inline]
  ...
  #[inline]
  pub fn designer_name_th(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_DESIGNER_NAME_TH, None)}
  }
  #[inline]
  pub fn designer_name_tw(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_DESIGNER_NAME_TW, None)}
  }
  #[inline]
  pub fn designer_name_en(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_DESIGNER_NAME_EN, None)}
  }
  #[inline]
  ...
  #[inline]
  pub fn illustrator_name_th(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_ILLUSTRATOR_NAME_TH, None)}
  }
  #[inline]
  pub fn illustrator_name_tw(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_ILLUSTRATOR_NAME_TW, None)}
  }
  #[inline]
  pub fn illustrator_name_en(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_ILLUSTRATOR_NAME_EN, None)}
  }
  #[inline]
  ...
  #[inline]
  pub fn character_voice_th(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_CHARACTER_VOICE_TH, None)}
  }
  #[inline]
  pub fn character_voice_tw(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_CHARACTER_VOICE_TW, None)}
  }
  #[inline]
  pub fn character_voice_en(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
  ...
  #[inline]
  pub fn hobby_th(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_HOBBY_TH, None)}
  }
  #[inline]
  pub fn hobby_tw(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_HOBBY_TW, None)}
  }
  #[inline]
  pub fn hobby_en(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_HOBBY_EN, None)}
  }
  #[inline]
  ...
  #[inline]
  pub fn weapon_name_th(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_WEAPON_NAME_TH, None)}
  }
  #[inline]
  pub fn weapon_desc_th(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_WEAPON_DESC_TH, None)}
  }
  #[inline]
  pub fn weapon_name_tw(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_WEAPON_NAME_TW, None)}
  }
  #[inline]
  pub fn weapon_desc_tw(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_WEAPON_DESC_TW, None)}
  }
  #[inline]
  pub fn weapon_name_en(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_WEAPON_NAME_EN, None)}
  }
  #[inline]
  pub fn weapon_desc_en(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_WEAPON_DESC_EN, None)}
  }
  #[inline]
  ...
  #[inline]
  pub fn profile_introduction_th(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_PROFILE_INTRODUCTION_TH, None)}
  }
  #[inline]
  pub fn profile_introduction_tw(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_PROFILE_INTRODUCTION_TW, None)}
  }
  #[inline]
  pub fn profile_introduction_en(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_PROFILE_INTRODUCTION_EN, None)}
  }
  #[inline]
  ...
  #[inline]
  pub fn character_ssr_new_th(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_CHARACTER_SSR_NEW_TH, None)}
  }
  #[inline]
  pub fn character_ssr_new_tw(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_CHARACTER_SSR_NEW_TW, None)}
  }
  #[inline]
  pub fn character_ssr_new_en(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LocalizeCharProfileExcel::VT_CHARACTER_SSR_NEW_EN, None)}
  }
}
...
impl flatbuffers::Verifiable for LocalizeCharProfileExcel<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("status_message_th", Self::VT_STATUS_MESSAGE_TH, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("status_message_tw", Self::VT_STATUS_MESSAGE_TW, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("status_message_en", Self::VT_STATUS_MESSAGE_EN, false)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("full_name_th", Self::VT_FULL_NAME_TH, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("full_name_tw", Self::VT_FULL_NAME_TW, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("full_name_en", Self::VT_FULL_NAME_EN, false)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("family_name_th", Self::VT_FAMILY_NAME_TH, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("family_name_ruby_th", Self::VT_FAMILY_NAME_RUBY_TH, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("personal_name_th", Self::VT_PERSONAL_NAME_TH, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("personal_name_ruby_th", Self::VT_PERSONAL_NAME_RUBY_TH, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("family_name_tw", Self::VT_FAMILY_NAME_TW, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("family_name_ruby_tw", Self::VT_FAMILY_NAME_RUBY_TW, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("personal_name_tw", Self::VT_PERSONAL_NAME_TW, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("personal_name_ruby_tw", Self::VT_PERSONAL_NAME_RUBY_TW, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("family_name_en", Self::VT_FAMILY_NAME_EN, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("family_name_ruby_en", Self::VT_FAMILY_NAME_RUBY_EN, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("personal_name_en", Self::VT_PERSONAL_NAME_EN, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("personal_name_ruby_en", Self::VT_PERSONAL_NAME_RUBY_EN, false)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("school_year_th", Self::VT_SCHOOL_YEAR_TH, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("school_year_tw", Self::VT_SCHOOL_YEAR_TW, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("school_year_en", Self::VT_SCHOOL_YEAR_EN, false)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("character_age_th", Self::VT_CHARACTER_AGE_TH, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("character_age_tw", Self::VT_CHARACTER_AGE_TW, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("character_age_en", Self::VT_CHARACTER_AGE_EN, false)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("birthday_th", Self::VT_BIRTHDAY_TH, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("birthday_tw", Self::VT_BIRTHDAY_TW, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("birthday_en", Self::VT_BIRTHDAY_EN, false)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("char_height_th", Self::VT_CHAR_HEIGHT_TH, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("char_height_tw", Self::VT_CHAR_HEIGHT_TW, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("char_height_en", Self::VT_CHAR_HEIGHT_EN, false)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("designer_name_th", Self::VT_DESIGNER_NAME_TH, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("designer_name_tw", Self::VT_DESIGNER_NAME_TW, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("designer_name_en", Self::VT_DESIGNER_NAME_EN, false)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("illustrator_name_th", Self::VT_ILLUSTRATOR_NAME_TH, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("illustrator_name_tw", Self::VT_ILLUSTRATOR_NAME_TW, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("illustrator_name_en", Self::VT_ILLUSTRATOR_NAME_EN, false)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("hobby_tw", Self::VT_HOBBY_TW, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("hobby_en", Self::VT_HOBBY_EN, false)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("weapon_name_th", Self::VT_WEAPON_NAME_TH, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("weapon_desc_th", Self::VT_WEAPON_DESC_TH, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("weapon_name_tw", Self::VT_WEAPON_NAME_TW, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("weapon_desc_tw", Self::VT_WEAPON_DESC_TW, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("weapon_name_en", Self::VT_WEAPON_NAME_EN, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("weapon_desc_en", Self::VT_WEAPON_DESC_EN, false)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("profile_introduction_th", Self::VT_PROFILE_INTRODUCTION_TH, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("profile_introduction_tw", Self::VT_PROFILE_INTRODUCTION_TW, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("profile_introduction_en", Self::VT_PROFILE_INTRODUCTION_EN, false)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("character_ssr_new_th", Self::VT_CHARACTER_SSR_NEW_TH, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("character_ssr_new_tw", Self::VT_CHARACTER_SSR_NEW_TW, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("character_ssr_new_en", Self::VT_CHARACTER_SSR_NEW_EN, false)?
     .finish();
    Ok(())
  }
}
pub struct LocalizeCharProfileExcelArgs<'a> {
    ...
    pub status_message_th: Option<flatbuffers::WIPOffset<&'a str>>,
    pub status_message_tw: Option<flatbuffers::WIPOffset<&'a str>>,
    pub status_message_en: Option<flatbuffers::WIPOffset<&'a str>>,
    pub full_name_kr: Option<flatbuffers::WIPOffset<&'a str>>,
    pub full_name_jp: Option<flatbuffers::WIPOffset<&'a str>>,
    pub full_name_th: Option<flatbuffers::WIPOffset<&'a str>>,
    pub full_name_tw: Option<flatbuffers::WIPOffset<&'a str>>,
    pub full_name_en: Option<flatbuffers::WIPOffset<&'a str>>,
    ...
    pub family_name_th: Option<flatbuffers::WIPOffset<&'a str>>,
    pub family_name_ruby_th: Option<flatbuffers::WIPOffset<&'a str>>,
    pub personal_name_th: Option<flatbuffers::WIPOffset<&'a str>>,
    pub personal_name_ruby_th: Option<flatbuffers::WIPOffset<&'a str>>,
    pub family_name_tw: Option<flatbuffers::WIPOffset<&'a str>>,
    pub family_name_ruby_tw: Option<flatbuffers::WIPOffset<&'a str>>,
    pub personal_name_tw: Option<flatbuffers::WIPOffset<&'a str>>,
    pub personal_name_ruby_tw: Option<flatbuffers::WIPOffset<&'a str>>,
    pub family_name_en: Option<flatbuffers::WIPOffset<&'a str>>,
    pub family_name_ruby_en: Option<flatbuffers::WIPOffset<&'a str>>,
    pub personal_name_en: Option<flatbuffers::WIPOffset<&'a str>>,
    pub personal_name_ruby_en: Option<flatbuffers::WIPOffset<&'a str>>,
    pub school_year_kr: Option<flatbuffers::WIPOffset<&'a str>>,
    pub school_year_jp: Option<flatbuffers::WIPOffset<&'a str>>,
    pub school_year_th: Option<flatbuffers::WIPOffset<&'a str>>,
    pub school_year_tw: Option<flatbuffers::WIPOffset<&'a str>>,
    pub school_year_en: Option<flatbuffers::WIPOffset<&'a str>>,
    pub character_age_kr: Option<flatbuffers::WIPOffset<&'a str>>,
    pub character_age_jp: Option<flatbuffers::WIPOffset<&'a str>>,
    pub character_age_th: Option<flatbuffers::WIPOffset<&'a str>>,
    pub character_age_tw: Option<flatbuffers::WIPOffset<&'a str>>,
    pub character_age_en: Option<flatbuffers::WIPOffset<&'a str>>,
    ...
    pub birthday_th: Option<flatbuffers::WIPOffset<&'a str>>,
    pub birthday_tw: Option<flatbuffers::WIPOffset<&'a str>>,
    pub birthday_en: Option<flatbuffers::WIPOffset<&'a str>>,
    pub char_height_kr: Option<flatbuffers::WIPOffset<&'a str>>,
    pub char_height_jp: Option<flatbuffers::WIPOffset<&'a str>>,
    pub char_height_th: Option<flatbuffers::WIPOffset<&'a str>>,
    pub char_height_tw: Option<flatbuffers::WIPOffset<&'a str>>,
    pub char_height_en: Option<flatbuffers::WIPOffset<&'a str>>,
    pub designer_name_kr: Option<flatbuffers::WIPOffset<&'a str>>,
    pub designer_name_jp: Option<flatbuffers::WIPOffset<&'a str>>,
    pub designer_name_th: Option<flatbuffers::WIPOffset<&'a str>>,
    pub designer_name_tw: Option<flatbuffers::WIPOffset<&'a str>>,
    pub designer_name_en: Option<flatbuffers::WIPOffset<&'a str>>,
    pub illustrator_name_kr: Option<flatbuffers::WIPOffset<&'a str>>,
    pub illustrator_name_jp: Option<flatbuffers::WIPOffset<&'a str>>,
    pub illustrator_name_th: Option<flatbuffers::WIPOffset<&'a str>>,
    pub illustrator_name_tw: Option<flatbuffers::WIPOffset<&'a str>>,
    pub illustrator_name_en: Option<flatbuffers::WIPOffset<&'a str>>,
    ...
    pub hobby_tw: Option<flatbuffers::WIPOffset<&'a str>>,
    pub hobby_en: Option<flatbuffers::WIPOffset<&'a str>>,
    ...
    pub weapon_name_th: Option<flatbuffers::WIPOffset<&'a str>>,
    pub weapon_desc_th: Option<flatbuffers::WIPOffset<&'a str>>,
    pub weapon_name_tw: Option<flatbuffers::WIPOffset<&'a str>>,
    pub weapon_desc_tw: Option<flatbuffers::WIPOffset<&'a str>>,
    pub weapon_name_en: Option<flatbuffers::WIPOffset<&'a str>>,
    pub weapon_desc_en: Option<flatbuffers::WIPOffset<&'a str>>,
    ...
    pub profile_introduction_th: Option<flatbuffers::WIPOffset<&'a str>>,
    pub profile_introduction_tw: Option<flatbuffers::WIPOffset<&'a str>>,
    pub profile_introduction_en: Option<flatbuffers::WIPOffset<&'a str>>,
    pub character_ssr_new_kr: Option<flatbuffers::WIPOffset<&'a str>>,
    pub character_ssr_new_jp: Option<flatbuffers::WIPOffset<&'a str>>,
    pub character_ssr_new_th: Option<flatbuffers::WIPOffset<&'a str>>,
    pub character_ssr_new_tw: Option<flatbuffers::WIPOffset<&'a str>>,
    pub character_ssr_new_en: Option<flatbuffers::WIPOffset<&'a str>>,
}
impl<'a> Default for LocalizeCharProfileExcelArgs<'a> {
  ...
  fn default() -> Self {
    LocalizeCharProfileExcelArgs {
      ...
      status_message_th: None,
      status_message_tw: None,
      status_message_en: None,
      full_name_kr: None,
      full_name_jp: None,
      full_name_th: None,
      full_name_tw: None,
      ...
      family_name_th: None,
      family_name_ruby_th: None,
      personal_name_th: None,
      personal_name_ruby_th: None,
      family_name_tw: None,
      family_name_ruby_tw: None,
      personal_name_tw: None,
      personal_name_ruby_tw: None,
      family_name_en: None,
      family_name_ruby_en: None,
      personal_name_en: None,
      personal_name_ruby_en: None,
      school_year_kr: None,
      school_year_jp: None,
      school_year_th: None,
      school_year_tw: None,
      ...
      character_age_th: None,
      character_age_tw: None,
      character_age_en: None,
      birth_day: None,
      birthday_kr: None,
      birthday_jp: None,
      birthday_th: None,
      ...
      designer_name_th: None,
      designer_name_tw: None,
      designer_name_en: None,
      illustrator_name_kr: None,
      illustrator_name_jp: None,
      illustrator_name_th: None,
      illustrator_name_tw: None,
      illustrator_name_en: None,
      ...
      profile_introduction_th: None,
      profile_introduction_tw: None,
      profile_introduction_en: None,
      character_ssr_new_kr: None,
      character_ssr_new_jp: None,
      character_ssr_new_th: None,
      character_ssr_new_tw: None,
      character_ssr_new_en: None,
    }
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> LocalizeCharProfileExcelBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_status_message_th(&mut self, status_message_th: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_STATUS_MESSAGE_TH, status_message_th);
  }
  #[inline]
  pub fn add_status_message_tw(&mut self, status_message_tw: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_STATUS_MESSAGE_TW, status_message_tw);
  }
  #[inline]
  pub fn add_status_message_en(&mut self, status_message_en: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_STATUS_MESSAGE_EN, status_message_en);
  }
  #[inline]
  ...
  #[inline]
  pub fn add_full_name_th(&mut self, full_name_th: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_FULL_NAME_TH, full_name_th);
  }
  #[inline]
  pub fn add_full_name_tw(&mut self, full_name_tw: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_FULL_NAME_TW, full_name_tw);
  }
  #[inline]
  pub fn add_full_name_en(&mut self, full_name_en: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_FULL_NAME_EN, full_name_en);
  }
  #[inline]
  ...
  #[inline]
  pub fn add_family_name_th(&mut self, family_name_th: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_FAMILY_NAME_TH, family_name_th);
  }
  #[inline]
  pub fn add_family_name_ruby_th(&mut self, family_name_ruby_th: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_FAMILY_NAME_RUBY_TH, family_name_ruby_th);
  }
  #[inline]
  pub fn add_personal_name_th(&mut self, personal_name_th: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_PERSONAL_NAME_TH, personal_name_th);
  }
  #[inline]
  pub fn add_personal_name_ruby_th(&mut self, personal_name_ruby_th: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_PERSONAL_NAME_RUBY_TH, personal_name_ruby_th);
  }
  #[inline]
  pub fn add_family_name_tw(&mut self, family_name_tw: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_FAMILY_NAME_TW, family_name_tw);
  }
  #[inline]
  pub fn add_family_name_ruby_tw(&mut self, family_name_ruby_tw: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_FAMILY_NAME_RUBY_TW, family_name_ruby_tw);
  }
  #[inline]
  pub fn add_personal_name_tw(&mut self, personal_name_tw: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_PERSONAL_NAME_TW, personal_name_tw);
  }
  #[inline]
  pub fn add_personal_name_ruby_tw(&mut self, personal_name_ruby_tw: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_PERSONAL_NAME_RUBY_TW, personal_name_ruby_tw);
  }
  #[inline]
  pub fn add_family_name_en(&mut self, family_name_en: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_FAMILY_NAME_EN, family_name_en);
  }
  #[inline]
  pub fn add_family_name_ruby_en(&mut self, family_name_ruby_en: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_FAMILY_NAME_RUBY_EN, family_name_ruby_en);
  }
  #[inline]
  pub fn add_personal_name_en(&mut self, personal_name_en: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_PERSONAL_NAME_EN, personal_name_en);
  }
  #[inline]
  pub fn add_personal_name_ruby_en(&mut self, personal_name_ruby_en: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_PERSONAL_NAME_RUBY_EN, personal_name_ruby_en);
  }
  #[inline]
  ...
  #[inline]
  pub fn add_school_year_th(&mut self, school_year_th: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_SCHOOL_YEAR_TH, school_year_th);
  }
  #[inline]
  pub fn add_school_year_tw(&mut self, school_year_tw: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_SCHOOL_YEAR_TW, school_year_tw);
  }
  #[inline]
  pub fn add_school_year_en(&mut self, school_year_en: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_SCHOOL_YEAR_EN, school_year_en);
  }
  #[inline]
  ...
  #[inline]
  pub fn add_character_age_th(&mut self, character_age_th: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_CHARACTER_AGE_TH, character_age_th);
  }
  #[inline]
  pub fn add_character_age_tw(&mut self, character_age_tw: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_CHARACTER_AGE_TW, character_age_tw);
  }
  #[inline]
  pub fn add_character_age_en(&mut self, character_age_en: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_CHARACTER_AGE_EN, character_age_en);
  }
  #[inline]
  ...
  #[inline]
  pub fn add_birthday_th(&mut self, birthday_th: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_BIRTHDAY_TH, birthday_th);
  }
  #[inline]
  pub fn add_birthday_tw(&mut self, birthday_tw: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_BIRTHDAY_TW, birthday_tw);
  }
  #[inline]
  pub fn add_birthday_en(&mut self, birthday_en: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_BIRTHDAY_EN, birthday_en);
  }
  #[inline]
  ...
  #[inline]
  pub fn add_char_height_th(&mut self, char_height_th: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_CHAR_HEIGHT_TH, char_height_th);
  }
  #[inline]
  pub fn add_char_height_tw(&mut self, char_height_tw: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_CHAR_HEIGHT_TW, char_height_tw);
  }
  #[inline]
  pub fn add_char_height_en(&mut self, char_height_en: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_CHAR_HEIGHT_EN, char_height_en);
  }
  #[inline]
  ...
  #[inline]
  pub fn add_designer_name_th(&mut self, designer_name_th: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_DESIGNER_NAME_TH, designer_name_th);
  }
  #[inline]
  pub fn add_designer_name_tw(&mut self, designer_name_tw: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_DESIGNER_NAME_TW, designer_name_tw);
  }
  #[inline]
  pub fn add_designer_name_en(&mut self, designer_name_en: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_DESIGNER_NAME_EN, designer_name_en);
  }
  #[inline]
  ...
  #[inline]
  pub fn add_illustrator_name_th(&mut self, illustrator_name_th: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_ILLUSTRATOR_NAME_TH, illustrator_name_th);
  }
  #[inline]
  pub fn add_illustrator_name_tw(&mut self, illustrator_name_tw: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_ILLUSTRATOR_NAME_TW, illustrator_name_tw);
  }
  #[inline]
  pub fn add_illustrator_name_en(&mut self, illustrator_name_en: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_ILLUSTRATOR_NAME_EN, illustrator_name_en);
  }
  #[inline]
  ...
  #[inline]
  pub fn add_character_voice_th(&mut self, character_voice_th: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_CHARACTER_VOICE_TH, character_voice_th);
  }
  #[inline]
  pub fn add_character_voice_tw(&mut self, character_voice_tw: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_CHARACTER_VOICE_TW, character_voice_tw);
  }
  #[inline]
  pub fn add_character_voice_en(&mut self, character_voice_en: flatbuffers::WIPOffset<&'b  str>) {
  ...
  #[inline]
  pub fn add_hobby_th(&mut self, hobby_th: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_HOBBY_TH, hobby_th);
  }
  #[inline]
  pub fn add_hobby_tw(&mut self, hobby_tw: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_HOBBY_TW, hobby_tw);
  }
  #[inline]
  pub fn add_hobby_en(&mut self, hobby_en: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_HOBBY_EN, hobby_en);
  }
  #[inline]
  ...
  #[inline]
  pub fn add_weapon_name_th(&mut self, weapon_name_th: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_WEAPON_NAME_TH, weapon_name_th);
  }
  #[inline]
  pub fn add_weapon_desc_th(&mut self, weapon_desc_th: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_WEAPON_DESC_TH, weapon_desc_th);
  }
  #[inline]
  pub fn add_weapon_name_tw(&mut self, weapon_name_tw: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_WEAPON_NAME_TW, weapon_name_tw);
  }
  #[inline]
  pub fn add_weapon_desc_tw(&mut self, weapon_desc_tw: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_WEAPON_DESC_TW, weapon_desc_tw);
  }
  #[inline]
  pub fn add_weapon_name_en(&mut self, weapon_name_en: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_WEAPON_NAME_EN, weapon_name_en);
  }
  #[inline]
  pub fn add_weapon_desc_en(&mut self, weapon_desc_en: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_WEAPON_DESC_EN, weapon_desc_en);
  }
  #[inline]
  ...
  #[inline]
  pub fn add_profile_introduction_th(&mut self, profile_introduction_th: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_PROFILE_INTRODUCTION_TH, profile_introduction_th);
  }
  #[inline]
  pub fn add_profile_introduction_tw(&mut self, profile_introduction_tw: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_PROFILE_INTRODUCTION_TW, profile_introduction_tw);
  }
  #[inline]
  pub fn add_profile_introduction_en(&mut self, profile_introduction_en: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_PROFILE_INTRODUCTION_EN, profile_introduction_en);
  }
  #[inline]
  ...
  #[inline]
  pub fn add_character_ssr_new_th(&mut self, character_ssr_new_th: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_CHARACTER_SSR_NEW_TH, character_ssr_new_th);
  }
  #[inline]
  pub fn add_character_ssr_new_tw(&mut self, character_ssr_new_tw: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_CHARACTER_SSR_NEW_TW, character_ssr_new_tw);
  }
  #[inline]
  pub fn add_character_ssr_new_en(&mut self, character_ssr_new_en: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LocalizeCharProfileExcel::VT_CHARACTER_SSR_NEW_EN, character_ssr_new_en);
  }
  #[inline]
...
impl core::fmt::Debug for LocalizeCharProfileExcel<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("LocalizeCharProfileExcel");
      ...
      ds.field("status_message_th", &self.status_message_th());
      ds.field("status_message_tw", &self.status_message_tw());
      ds.field("status_message_en", &self.status_message_en());
      ds.field("full_name_kr", &self.full_name_kr());
      ds.field("full_name_jp", &self.full_name_jp());
      ds.field("full_name_th", &self.full_name_th());
      ds.field("full_name_tw", &self.full_name_tw());
      ds.field("full_name_en", &self.full_name_en());
      ...
      ds.field("family_name_th", &self.family_name_th());
      ds.field("family_name_ruby_th", &self.family_name_ruby_th());
      ds.field("personal_name_th", &self.personal_name_th());
      ds.field("personal_name_ruby_th", &self.personal_name_ruby_th());
      ds.field("family_name_tw", &self.family_name_tw());
      ds.field("family_name_ruby_tw", &self.family_name_ruby_tw());
      ds.field("personal_name_tw", &self.personal_name_tw());
      ds.field("personal_name_ruby_tw", &self.personal_name_ruby_tw());
      ds.field("family_name_en", &self.family_name_en());
      ds.field("family_name_ruby_en", &self.family_name_ruby_en());
      ds.field("personal_name_en", &self.personal_name_en());
      ds.field("personal_name_ruby_en", &self.personal_name_ruby_en());
      ds.field("school_year_kr", &self.school_year_kr());
      ds.field("school_year_jp", &self.school_year_jp());
      ds.field("school_year_th", &self.school_year_th());
      ds.field("school_year_tw", &self.school_year_tw());
      ds.field("school_year_en", &self.school_year_en());
      ds.field("character_age_kr", &self.character_age_kr());
      ds.field("character_age_jp", &self.character_age_jp());
      ds.field("character_age_th", &self.character_age_th());
      ds.field("character_age_tw", &self.character_age_tw());
      ds.field("character_age_en", &self.character_age_en());
      ds.field("birth_day", &self.birth_day());
      ds.field("birthday_kr", &self.birthday_kr());
      ds.field("birthday_jp", &self.birthday_jp());
      ds.field("birthday_th", &self.birthday_th());
      ds.field("birthday_tw", &self.birthday_tw());
      ds.field("birthday_en", &self.birthday_en());
      ds.field("char_height_kr", &self.char_height_kr());
      ds.field("char_height_jp", &self.char_height_jp());
      ds.field("char_height_th", &self.char_height_th());
      ds.field("char_height_tw", &self.char_height_tw());
      ds.field("char_height_en", &self.char_height_en());
      ds.field("designer_name_kr", &self.designer_name_kr());
      ds.field("designer_name_jp", &self.designer_name_jp());
      ds.field("designer_name_th", &self.designer_name_th());
      ds.field("designer_name_tw", &self.designer_name_tw());
      ds.field("designer_name_en", &self.designer_name_en());
      ds.field("illustrator_name_kr", &self.illustrator_name_kr());
      ds.field("illustrator_name_jp", &self.illustrator_name_jp());
      ds.field("illustrator_name_th", &self.illustrator_name_th());
      ds.field("illustrator_name_tw", &self.illustrator_name_tw());
      ds.field("illustrator_name_en", &self.illustrator_name_en());
      ...
      ds.field("hobby_tw", &self.hobby_tw());
      ds.field("hobby_en", &self.hobby_en());
      ...
      ds.field("weapon_name_th", &self.weapon_name_th());
      ds.field("weapon_desc_th", &self.weapon_desc_th());
      ds.field("weapon_name_tw", &self.weapon_name_tw());
      ds.field("weapon_desc_tw", &self.weapon_desc_tw());
      ds.field("weapon_name_en", &self.weapon_name_en());
      ds.field("weapon_desc_en", &self.weapon_desc_en());
      ...
      ds.field("profile_introduction_th", &self.profile_introduction_th());
      ds.field("profile_introduction_tw", &self.profile_introduction_tw());
      ds.field("profile_introduction_en", &self.profile_introduction_en());
      ds.field("character_ssr_new_kr", &self.character_ssr_new_kr());
      ds.field("character_ssr_new_jp", &self.character_ssr_new_jp());
      ds.field("character_ssr_new_th", &self.character_ssr_new_th());
      ds.field("character_ssr_new_tw", &self.character_ssr_new_tw());
      ds.field("character_ssr_new_en", &self.character_ssr_new_en());
      ds.finish()
  }
}
...
impl<'a> MemoryLobbyExcel<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    builder.add_character_id(args.character_id);
    builder.add_id(args.id);
    if let Some(x) = args.audio_clip_en { builder.add_audio_clip_en(x); }
    if let Some(x) = args.audio_clip_tw { builder.add_audio_clip_tw(x); }
    if let Some(x) = args.audio_clip_th { builder.add_audio_clip_th(x); }
  ...
  pub fn audio_clip_th(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(MemoryLobbyExcel::VT_AUDIO_CLIP_TH, None)}
  }
  #[inline]
  pub fn audio_clip_tw(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(MemoryLobbyExcel::VT_AUDIO_CLIP_TW, None)}
  }
  #[inline]
  pub fn audio_clip_en(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(MemoryLobbyExcel::VT_AUDIO_CLIP_EN, None)}
  }
}
...
impl flatbuffers::Verifiable for MemoryLobbyExcel<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("audio_clip_th", Self::VT_AUDIO_CLIP_TH, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("audio_clip_tw", Self::VT_AUDIO_CLIP_TW, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("audio_clip_en", Self::VT_AUDIO_CLIP_EN, false)?
     .finish();
    Ok(())
  }
}
pub struct MemoryLobbyExcelArgs<'a> {
    ...
    pub audio_clip_th: Option<flatbuffers::WIPOffset<&'a str>>,
    pub audio_clip_tw: Option<flatbuffers::WIPOffset<&'a str>>,
    pub audio_clip_en: Option<flatbuffers::WIPOffset<&'a str>>,
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> MemoryLobbyExcelBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_audio_clip_th(&mut self, audio_clip_th: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MemoryLobbyExcel::VT_AUDIO_CLIP_TH, audio_clip_th);
  }
  #[inline]
  pub fn add_audio_clip_tw(&mut self, audio_clip_tw: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MemoryLobbyExcel::VT_AUDIO_CLIP_TW, audio_clip_tw);
  }
  #[inline]
  pub fn add_audio_clip_en(&mut self, audio_clip_en: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MemoryLobbyExcel::VT_AUDIO_CLIP_EN, audio_clip_en);
  }
  #[inline]
